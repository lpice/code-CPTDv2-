...
PhotoData <- read.table("../../Data/LiCor/our 2016 sites.csv",
                        header=T,sep=",",
                        stringsAsFactors = F)
...
write.table(data.frame(PhotoData,Vcmax,Jmax),file="../../results/EstimateJmaxVcmaxfromLicorData.csv",sep=",",row.names=F)
